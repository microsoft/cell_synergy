...
def convert_to_tensor_dataset(samples: List[Dict]) -> TensorDataset:
    ...
    if len(unique_img_dims) > 1:
        ...
        print(f"Multiple image embedding dimensions detected. Using most common: {most_common_img_dim}")
    ...
    if len(unique_gex_dims) > 1:
        ...
        print(f"Multiple gene expression embedding dimensions detected. Using most common: {most_common_gex_dim}")
