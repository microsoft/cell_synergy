...
def main():
    ...
    parser.add_argument("--dissociated-dir", type=str, 
                        default="/home/icb/till.richter/git/data_scaling/original_data/data/dissociated_to_tokenize",
                        help="Directory containing dissociated h5ad files")
    
    parser.add_argument("--spatial-dir", type=str, 
                        default="/home/icb/till.richter/git/data_scaling/original_data/data/data_to_tokenize",
                        help="Directory containing spatial h5ad files")
    
    parser.add_argument("--output-dir", type=str, 
                        default="/home/icb/till.richter/git/data_scaling/project_folder",
